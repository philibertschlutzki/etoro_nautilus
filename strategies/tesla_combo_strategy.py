...
class ComboTrendVwapConfig(StrategyConfig, frozen=True):
    ...
    bb_entry_tolerance: float = 0.005  # 0,5 % Toleranz um das untere Band
...
class ComboTrendVwapStrategy(Strategy):
    ...
    def on_bar(self, bar: Bar):
        ...
        # 3. Einstieg: Preis nahe dem unteren Bollinger Band
        entry_trigger = close_price <= self.bb.lower_band * (1.0 + self.config.bb_entry_tolerance)
