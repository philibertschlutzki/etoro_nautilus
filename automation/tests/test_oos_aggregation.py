...
def test_oos_aggregation():
    ...
    all_results = [
        {
            ...
            "oos_metrics": { "total_trades": 5, "sortino_ratio": 1.0, "profit_factor": 1.0, "max_drawdown": 0.05, "win_rate": 0.5, "total_return": 0.1 }
        },
        {
            "symbol": "SYM1",
            "strategy": "StrategyB",
        ...
        },
        {
            ...
            "strategy": "StrategyA",
            "metrics": { "total_trades": 20, "sortino_ratio": 50.0, "profit_factor": 1.5, "max_drawdown": 0.1, "win_rate": 0.6, "total_return": 0.5 },
            "oos_metrics": { "total_trades": 5, "sortino_ratio": 1.0, "profit_factor": 1.0, "max_drawdown": 0.05, "win_rate": 0.5, "total_return": 0.2 }
        },
        {
            "symbol": "SYM2",
            "strategy": "StrategyB",
    ...
    assert aggregate_winner["oos_eligible"] is True, "OOS eligible should be true since sum is 10"
    assert aggregate_winner["oos_metrics"]["total_trades"] == 10
