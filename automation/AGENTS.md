...
|-------|----------|---------|
| 2026-06-05 | **Issue #211 (State-Mutation vor Early-Returns):** State-Zuweisung in VWAP-Strategie nach Early-Returns verschoben, um Signal-Desync zu verhindern. | automation/strategies/vwap_exhaustion.py, automation/AGENTS.md, automation/tests/test_vwap_exhaustion_state.py |
