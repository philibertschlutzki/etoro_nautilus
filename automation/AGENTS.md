...
| 2026-06-12 | **Issue #371 (ComboTrendVwap Zero Hardcoding):** Binding trend entry tolerance und bb_touch_window wurden als parametrisierbare Variablen `trend_tolerance_pct` (0.02) und `bb_touch_window` (24) extrahiert, um hardcodierte Float-Multiplikatoren (0.98/1.02) und fixe Int-Grenzen in der Strategie zu entfernen. | `automation/strategies/tesla_combo_strategy.py`, `automation/config/strategy_defaults.json` |
