...
| 2026-06-11 | **Bugfix `_run_remaining_sequentially` TypeError:** Fixed missing arguments in `_run_remaining_sequentially` fallback triggering TypeError on ProcessPool crash | `automation/backtest_runner.py`, `automation/tests/test_backtest_runner.py`, `automation/AGENTS.md` |
