...
### 🟢 Pitfall #75 — Per-Symbol-Sweep: konstanter Reward −9.75 (Unevaluable-Floor-Kollaps durch saturiertes Shaping) [BEHOBEN: Issues #404–#410]
...
- ✅ **#409 (P2) Fail-Loud-Guard** — `floor_plateau_callback` warnt einmal pro Study, wenn nach `n_startup_trials` alle Trials am Unevaluable-Floor (`penalty_unevaluable_oos + unevaluable_shaping_span`) kleben.
