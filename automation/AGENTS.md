...
| 2026-06-08 | Issue #204 (Strategy Duplication Bias): Die Defaults der MeanReversionStrategy in strategy_defaults.json wurden auf 20/20/2.0 zurückgesetzt, um sie von der HourlyMeanReversionStrategy (10/10/1.5) zu differenzieren. Dies verhindert das Testen identischer Klone im Matrix-Backtest und beseitigt den systematischen Verzerrungs-Bias bei der Turnier-Auswertung. | automation/config/strategy_defaults.json, automation/AGENTS.md |
