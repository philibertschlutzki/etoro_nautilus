...
| 2026-05-28 | daily_orchestrator.py — Phase 5 Live Deployment: Bot-Skript Pfad auf `automation/momentum_ls_run.py` korrigiert und Bot als refaktoriertes Standalone-Skript angelegt. | automation/daily_orchestrator.py, automation/momentum_ls_run.py |
| 2026-05-28 | historical_fetcher.py — Phase 2d: Delta-Update Logik korrigiert (Verwendung von _get_oldest_ts_ns statt _get_latest_ts_ns für korrekte Rückwärts-Iteration in die Vergangenheit). | automation/historical_fetcher.py |
