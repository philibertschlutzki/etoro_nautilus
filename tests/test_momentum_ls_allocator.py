...
from adapters.momentum_ls_allocator import MomentumLSAllocator
from strategies.momentum_ls_sma import MomentumLSSmaStrategy, MomentumLSSmaConfig
...
def test_strategy_cache_balance_fetching():
    ...
    from strategies.momentum_ls_base import MomentumLSBaseStrategy
